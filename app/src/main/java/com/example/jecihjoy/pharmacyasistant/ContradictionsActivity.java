...
public class ContradictionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        medicines = databaseAdapter.getContradictions();
    ...
    public class MyMedRecyclerAdapter extends  RecyclerView.Adapter<MyMedRecyclerAdapter.MedAdapterViewHolder> {
        ...
        public void onBindViewHolder(MedAdapterViewHolder holder, final int position) {
            ...
            holder.mTxtName.setText("Drug "+md.getOldMed() + " of type "+md.getTypeA());
            holder.mTxtType.setText("Contradicts with: "+md.getNewMed()+ " of type "+md.getTypeB());
            holder.mTxtAmount.setText("Effects: "+md.getReason());
            holder.mTxtDate.setText("Alternatives for "+md.getNewMed()+" includes "+md.getAlternatives());
