...
/**
 * Created by Jecihjoy on 4/19/2018.
 */
...
public class PlacesAdapter extends RecyclerView.Adapter<PlacesAdapter.ViewHolder> {
    ...
    public PlacesAdapter(List<Place> list, Context ctx) {
        placesList = list;
        context = ctx;
    }
    @Override
    ...
    @Override
    public PlacesAdapter.ViewHolder
    onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.placeslayout, parent, false);

        PlacesAdapter.ViewHolder viewHolder =
                new PlacesAdapter.ViewHolder(view);
        return viewHolder;
    }
    ...
    private void showOnMap(Place place){
        FragmentManager fm = ((GooglePlacesActivity)context)
