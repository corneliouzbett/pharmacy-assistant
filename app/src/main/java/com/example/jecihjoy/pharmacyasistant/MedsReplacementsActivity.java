...
public class MedsReplacementsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        medicines = databaseAdapter.getReplacedMeds();
    ...
    public class MyMedRecyclerAdapter extends  RecyclerView.Adapter<MyMedRecyclerAdapter.MedAdapterViewHolder> {
        ...
        public void onBindViewHolder(MedAdapterViewHolder holder, final int position) {
            ...
            holder.mTxtName.setText("Replaced: "+md.getOldMed());
            holder.mTxtType.setText("By: "+md.getNewMed());
            holder.mTxtAmount.setText("Reason: "+md.getReason());
